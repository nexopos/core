...
@section( 'layout.base.body' )
    <div id="not-found-exception-page" class="h-full w-full overflow-y-auto pb-10 bg-gradient-to-bl from-purple-300 to-purple-700 flex items-center justify-center">
