...
@section( 'layout.base.body' )
    <div id="not-allowed-exception-page" class="h-full w-full overflow-y-auto pb-10 bg-gradient-to-bl from-purple-500 to-pink-500 flex items-center justify-center">
