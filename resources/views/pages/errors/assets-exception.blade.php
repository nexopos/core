...
@section( 'layout.default.body' )
    <div id="assets-exception-page" class="h-full w-full overflow-y-auto pb-10 bg-gradient-to-bl from-red-500 to-pink-500 flex items-center justify-center">
        <div class="w-full md:w-1/2 xl:1/3 flex items-center flex-col justify-center">
            ...
            <div class="my-2 shadow overflow-hidden rounded bg-white w-95vw md:w-3/4 lg:w-3/5">
                <p class="md:w-auto w-95vw bg-gray-700 lg:text-lg text-center p-4">{{ $message }}</p>
                @if ( ns()->isProduction() ) 
